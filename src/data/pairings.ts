...
export const PAIRINGS: Record<FishId, FishPairing> = {
  salmon: {
    ...
    toppings: { scallion: 0.45, sesame: 0.25, yuzukosho: 0.2, shichimi: 0.1, wasabi: 0.05 },
  ...
  toroSalmon: {
    ...
    toppings: { scallion: 0.4, yuzukosho: 0.3, sesame: 0.15, shichimi: 0.1 },
    note: 'Belly fat wants restraint: a brush of yuzu shio and a quick torch.',
  },
  tuna: {
    sauces: { nikiri: 0.35, shoyu: 0.3, umeShoyu: 0.15, yuzuShio: 0.1, none: 0.1 },
    torch: 0.3,
    riceExtras: { wasabi: 0.9, shiso: 0.05 },
    toppings: { scallion: 0.35, sesame: 0.3, wasabi: 0.15, shichimi: 0.15, yuzukosho: 0.05 },
    note: 'Lean akami is the wasabi-and-soy classic; keep the torch short.',
  },
  toroTuna: {
    sauces: { nikiri: 0.45, yuzuShio: 0.3, none: 0.15, umeShoyu: 0.1 },
    torch: 0.6,
    riceExtras: { wasabi: 0.75, shiso: 0.15 },
    toppings: { scallion: 0.35, yuzukosho: 0.3, shichimi: 0.15, sesame: 0.1, wasabi: 0.1 },
  ...
  yellowtail: {
    ...
    toppings: { yuzukosho: 0.45, scallion: 0.3, shichimi: 0.15, sesame: 0.1 },
  ...
  shrimp: {
    ...
    toppings: { sesame: 0.4, scallion: 0.3, shichimi: 0.15, yuzukosho: 0.15 },
  ...
  mackerel: {
    ...
    toppings: { scallion: 0.35, sesame: 0.3, yuzukosho: 0.25, shichimi: 0.1 },
  ...
  scallop: {
    ...
    toppings: { yuzukosho: 0.35, sesame: 0.3, shichimi: 0.2, scallion: 0.15 },
  ...
  seabream: {
    ...
    toppings: { yuzukosho: 0.3, scallion: 0.3, shichimi: 0.2, sesame: 0.2 },
